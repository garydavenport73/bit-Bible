...
<body>
  ...
  <main>
    ...
    <div class="app" id="app-download">
        ...
        <p>
          <button>
            <a href="bitbibleOffline.php" download=""
              >Download</a
            >
          </button>
        </p>
        ...
        <div id="iphone-instructions">
          <p>
            1) Open the
            <a href="bitbibleOfflineIPhone.php" target="_blank"
              ><u><b>iPhone offline webpage (69mb)</b></u></a
        ...
        <p>
          ...
          <a href="https://support.apple.com/en-us/HT200294" target="_blank"
            ><u><b>Apple Support</b></u></a
          >
          page.
        </p>
        <hr>
